...
const getKaggleUserDetails = (cookieStr, xsrfToken) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const headers = {
        cookie: cookieStr,
    ...
    const getResponse = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            if ((responseData === null || responseData === void 0 ? void 0 : responseData.userName) === undefined ||
                (responseData === null || responseData === void 0 ? void 0 : responseData.userName) === null ||
                (responseData === null || responseData === void 0 ? void 0 : responseData.userName) === "") {
                throw new Error("Missing Username");
            }
            return responseData === null || responseData === void 0 ? void 0 : responseData.userName;
        }
        catch (error) {
    ...
    return {
        userName: (_a = (yield getResponse())) !== null && _a !== void 0 ? _a : "",
    };
});
function ReclaimKaggle({ title, subTitle, cta, onSuccess, onFail, }) {
    ...
    const [kaggleUsername, setKaggleUsername] = React.useState("");
    ...
    const performGetCookies = () => __awaiter(this, void 0, void 0, function* () {
        try {
            const resCookies = yield getCookies();
            ...
            if (reqTokens.every((token) => !!token)) {
                ...
                const kaggleInfo = yield getKaggleUserDetails(cookieVal, reqTokens[2].value);
    ...
    return (<react_native_1.View>
      {webViewVisible ? (<>
          <react_native_1.View style={styles.providerHeaderContainer}>
            ...
            <react_native_1.View style={styles.providerHeader}>
              ...
              <react_native_1.Text style={styles.providerSubheading}>
                {extractHostname(KAGGLE_URL)}
              </react_native_1.Text>
            </react_native_1.View>
            {loading ? <LoadingSpinner_1.default /> : <react_native_1.Text> </react_native_1.Text>}
          </react_native_1.View>

          <react_native_webview_1.default source={{ uri: KAGGLE_URL }} thirdPartyCookiesEnabled={true} 
        // @ts-ignore
        ref={ref} setSupportMultipleWindows={false} style={{ height: ScreenHeight, width: ScreenWidth }} userAgent={react_native_1.Platform.OS === ANDROID
                ...
                : "AppleWebKit/602.1.50 (KHTML, like Gecko) CriOS/56.0.2924.75"} onLoadProgress={react_native_1.Platform.OS === ANDROID
                ? () => __awaiter(this, void 0, void 0, function* () { return yield performGetCookies(); })
                : undefined} onLoadEnd={react_native_1.Platform.OS === ANDROID
                ? undefined
                : () => __awaiter(this, void 0, void 0, function* () { return yield performGetCookies(); })}/>
        </>) : (<react_native_1.View style={styles.ReclaimKaggleCard}>
                ...
                if (runonce) {
                    const claimRequest = {
                        ...
                        request: {
                            ...
                            params: {
                                username: String(kaggleUsername),
                                csrfToken: String(xsrfToken),
                            },
                            secretParams: {
                    ...
                    (_a = claimRef.current) === null || _a === void 0 ? void 0 : _a.injectJavaScript(`window.postMessage(${JSON.stringify(claimRequest)})`);
                }
